...
class ServiceRound extends Table
{
    public function setup($param = []) 
    {
        $param = ['row_name'=>'Service round','col_label'=>'name','pop_up'=>false];
        parent::setup($param);

        $this->addTableCol(['id'=>'round_id','type'=>'INTEGER','title'=>'round ID','key'=>true,'key_auto'=>true,'list'=>false]);
        ...
        $this->addSearch(['round_id','name','sort','status'],['rows'=>1]);
