...
class ServicePrice extends Table
{
    public function setup($param = []) 
    {
        ...
        $this->addTableCol(['id'=>'item_id','type'=>'INTEGER','title'=>'Item','join'=>'CONCAT(I.name,": ",U.name) FROM '.TABLE_PREFIX.'service_item AS I JOIN '.TABLE_PREFIX.'item_units AS U USING(units_id) WHERE I.item_id']);
        $this->addTableCol(['id'=>'location_category_id','type'=>'INTEGER','title'=>'Location category','join'=>'name FROM '.TABLE_PREFIX.'location_category WHERE category_id']);
