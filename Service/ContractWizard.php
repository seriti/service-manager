...
class ContractWizard extends Wizard 
{
    ...
    public function setup($param = []) 
    {
        ...
        $this->addVariable(array('id'=>'agent_id','type'=>'INTEGER','title'=>'Agent','required'=>true));
        ...
        $this->addPage(1,'Setup','service/contract_page1.php',['go_back'=>true]);
        $this->addPage(2,'Select client','service/contract_page2.php');
        $this->addPage(3,'Confirm details','service/contract_page3.php');
        $this->addPage(4,'Summary','service/contract_page4.php',['final'=>true]);
